...
ulaz_trening, ulaz_test, izlaz_trening, izlaz_test = train_test_split(ulaz, izlaz_cat, test_size=0.2, shuffle=True, random_state=15)
...
history = model.fit(ulaz_trening, izlaz_trening, epochs=1000, batch_size=64, verbose=0)
